...
void main() {
  ...
  if(lambertian < 0.01){ // determines the portion of surface area that each of the 4 sections takes up
	lambertian = 0.15; // determines the brightness of each of the 4 sections
  }
